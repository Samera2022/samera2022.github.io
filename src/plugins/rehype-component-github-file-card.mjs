 ...
 * @param {string} [properties.path] - Alias for file path.
 * @param {string} [properties.description] - Description of the file.
 * @param {string} [properties.ref] - Git reference (branch, tag, or commit).
 * @param {import('mdast').RootContent[]} children - The children elements of the component.
 * @returns {*} The created GitHub File Card component.
 */
export function GithubFileCardComponent(properties, children) {
	...
	const fileTypeLabel = fileName.includes(".")
		? /** @type {string} */ (fileName.split(".").pop()).toLowerCase()
		: "file";

	const encodedFilePath = filePath
		.split("/")
		.map((/** @type {string} */ segment) => encodeURIComponent(segment))
		.join("/");
